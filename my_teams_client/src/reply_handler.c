...
void (*const reply_handler[])(reply_data_t *) = {
    ...
    [ERROR_UNKNOWN_TEAM] = NULL,
    [ERROR_UNKNOWN_CHANNEL] = NULL,
    [ERROR_UNKNOWN_THREAD] = NULL,
    [ERROR_UNKNOWN_USER] = NULL,
    [ERROR_ALREADY_EXIST] = NULL,

    [REPLY_SUBSCRIBE_CMD] = NULL,
    [REPLY_SUBSCRIBED_TEAM_CMD] = NULL,
    [REPLY_SUBSCRIBED_USER_CMD] = NULL,
    [REPLY_UNSUBSCRIBE_CMD] = NULL,

    [REPLY_INFO_USER_CMD] = NULL,
    [REPLY_INFO_TEAM_CMD] = NULL,
    [REPLY_INFO_CHANNEL_CMD] = NULL,
    [REPLY_INFO_THREAD_CMD] = NULL
};
